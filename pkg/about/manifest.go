...
type Resource struct {
	...
	BndLastModified                    float64 `json:"Bnd-LastModified,omitempty"`
	BundleName                         string  `json:"Bundle-Name,omitempty"`
	BuildJdk                           any     `json:"Build-Jdk,omitempty"`
	...
	ImplementationVersion              any     `json:"Implementation-Version,omitempty"`
	...
	BundleManifestVersion              float64 `json:"Bundle-ManifestVersion,omitempty"`
	BundleVersion                      any     `json:"Bundle-Version,omitempty"`
	...
	BuildJdkSpec                       float64 `json:"Build-Jdk-Spec,omitempty"`
	GitCommitId                        string  `json:"Git-Commit-Id,omitempty"`
	XCompileSourceJDK                  float64 `json:"X-Compile-Source-JDK,omitempty"`
	XCompileTargetJDK                  float64 `json:"X-Compile-Target-JDK,omitempty"`
